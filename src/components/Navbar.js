              ...
              Jan Kotania
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        <motion.button
                            ...
                            className="ml-4 px-6 py-2 border border-mono-primary text-mono-primary hover:bg-mono-primary hover:text-mono-background rounded-lg transition-all duration-300"
                        >
                            Resume
                        </motion.button>
                    </div>
                ...
                >
                    <div className="py-4 space-y-2">
                        ...
                        <button className="w-full mt-4 px-6 py-2 border border-mono-primary text-mono-primary hover:bg-mono-primary hover:text-mono-background rounded-lg transition-all duration-300">
                            Resume
                        </button>
                    </div>
                </motion.div>
